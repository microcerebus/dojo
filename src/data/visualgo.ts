...
export const VISUALGO_CATALOG: VisualgoEntry[] = [
  {
    ...
    url: `${VISUALGO_BASE}/array`,
    moduleIds: ['arrays-strings'],
  },
  {
    id: 'list',
    title: 'Linked List',
    category: 'Data structures',
    url: `${VISUALGO_BASE}/list`,
    moduleIds: ['linked-lists'],
  },
  {
    id: 'heap',
    title: 'Binary Heap',
    category: 'Data structures',
    url: `${VISUALGO_BASE}/heap`,
    moduleIds: ['heaps-tries'],
  },
  {
    id: 'hashtable',
    title: 'Hash Table',
  ...
  },
  {
    ...
    category: 'Data structures',
    url: `${VISUALGO_BASE}/graphds`,
    moduleIds: ['trees-graphs'],
  },
  {
    id: 'ufds',
    title: 'Union-Find Disjoint Sets',
    category: 'Data structures',
    url: `${VISUALGO_BASE}/ufds`,
    moduleIds: ['trees-graphs', 'hard'],
  },
  {
    id: 'fenwicktree',
    title: 'Fenwick Tree',
    category: 'Data structures',
    url: `${VISUALGO_BASE}/fenwicktree`,
    moduleIds: [],
  },
  {
    id: 'segmenttree',
...

  {
    ...
    url: `${VISUALGO_BASE}/sorting`,
    moduleIds: ['sorting-searching'],
  },

  {
    id: 'bitmask',
    title: 'Bitmask',
    category: 'Recursion & bit tricks',
    url: `${VISUALGO_BASE}/bitmask`,
    moduleIds: ['bit-manipulation', 'recursion-dp'],
  },
  {
    id: 'recursion',
    title: 'Recursion Tree / DAG',
    category: 'Recursion & bit tricks',
    url: `${VISUALGO_BASE}/recursion`,
    moduleIds: ['recursion-dp'],
  },
  ...
  },
  {
    ...
    category: 'Graph algorithms',
    url: `${VISUALGO_BASE}/mst`,
    moduleIds: ['advanced-topics'],
  },
  {
    id: 'sssp',
    title: 'Single-Source Shortest Paths',
    category: 'Graph algorithms',
    url: `${VISUALGO_BASE}/sssp`,
    moduleIds: ['advanced-topics'],
  },
  {
    id: 'cyclefinding',
  ...
  {
    id: 'maxflow',
    title: 'Max Flow / Network Flow',
    category: 'Graph algorithms',
    url: `${VISUALGO_BASE}/maxflow`,
    moduleIds: [],
  },
  {
    id: 'matching',
...

  {
    id: 'suffixtree',
    title: 'Suffix Tree',
    category: 'String structures',
    url: `${VISUALGO_BASE}/suffixtree`,
    moduleIds: [],
  },
  {
    id: 'suffixarray',
  ...
  },
  {
    ...
    title: 'Convex Hull',
    category: 'Geometry',
    url: `${VISUALGO_BASE}/convexhull`,
    moduleIds: [],
  },

  {
    id: 'reductions',
    title: 'NP-Complete Reductions',
    category: 'Theory',
    url: `${VISUALGO_BASE}/reductions`,
    moduleIds: ['advanced-topics'],
  },
];
