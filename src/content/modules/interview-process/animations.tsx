...
const axisFrames: AxisFrame[] = [
  {
    ...
    detail:
      'A number may get attached at the end, but it is a summary of a judgement, not the output of a formula.',
  },
  ...AXES.map((axis, i) => ({
    focus: i,
  ...
  },
  {
    ...
    detail:
      'False negatives are a cost companies accept. False positives are the thing they are really guarding against.',
  },
];
...
const SLICES = [
  {
    ...
    minutes: 5,
    detail:
      'Introductions and a behavioural question or two. Have your 90-second pitch ready so this costs you no thinking.',
  },
  {
    key: 'clarify',
    label: 'clarify',
    minutes: 5,
    detail:
      'Restate the problem. Pin down input types, sizes, duplicates, sortedness, and what to return on empty. Every constraint you are given is a hint.',
  },
  {
    key: 'example',
    label: 'example',
    minutes: 3,
    detail:
      'Draw one specific example, big enough to show a pattern and not accidentally a special case.',
  },
  {
    key: 'optimise',
    label: 'brute + optimise',
    minutes: 10,
    detail:
      'State the brute force with its complexity, then improve it out loud. This is where the interview is won, and it is entirely verbal.',
  },
  {
    key: 'walk',
    label: 'walk through',
    minutes: 3,
    detail:
      'Talk the whole algorithm through before typing. Fixing a design on a whiteboard is cheap; fixing half-written code is not.',
  },
  {
    key: 'code',
    label: 'code',
    minutes: 12,
    detail: 'Clean, modular, real names. Push details into helpers you define afterwards.',
  },
  {
    key: 'test',
    label: 'test',
    minutes: 5,
    detail:
      'Conceptual read-through, then odd-looking lines, then a small case, then edge cases. Volunteer the complexity without being asked.',
  },
  {
    key: 'ask',
    label: 'your questions',
    minutes: 2,
    detail: 'Two or three specific questions, prepared in advance. They count.',
  },
];
...
const timelineFrames = [
  ...
  })),
  {
    ...
    detail:
      'Practise against a clock. The budget is a habit, not a plan you consult mid-interview.',
  },
];
